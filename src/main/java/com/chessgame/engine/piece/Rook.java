...
public class Rook extends Piece {
	...
	public Rook(Alliance alliance, Point position) {
	...
	@Override
		...
		DIRECTION_VECTORS.forEach(v -> addMovesUntilPieceOrBorderHit(this.getPosition(), v, board, pseudoMoves));
		return pseudoMoves;
        }
	...
	public Piece withPosition(Point newPosition) {
		return new Rook(this.getAlliance(), newPosition);
	}

	@Override
	public String toString() {
		return getAlliance().toString() + "Rook";
	}
